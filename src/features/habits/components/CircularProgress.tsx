export function CircularProgress({ value }: { value: number }) {
  return (
    <div className="relative flex h-[82px] w-[82px] shrink-0 items-center justify-center rounded-full" style={{ background: `conic-gradient(#ffd400 ${value * 3.6}deg, #282828 0deg)` }} role="progressbar" aria-label={`${value}% completo`} aria-valuemin={0} aria-valuemax={100} aria-valuenow={value}>
